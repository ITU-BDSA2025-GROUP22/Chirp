    ...
    public partial class Like : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuthorFollowers", x => new { x.FollowersAuthorId, x.FollowingAuthorId });
                    table.ForeignKey(
                        name: "FK_AuthorFollowers_Authors_FollowersAuthorId",
                        column: x => x.FollowersAuthorId,
                        principalTable: "Authors",
                        principalColumn: "AuthorId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AuthorFollowers_Authors_FollowingAuthorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuthorFollowers_FollowingAuthorId",
